...
export default function Products() {
  ...
  return (
    <div className="container py-8 md:py-12" id="products">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 items-stretch rounded-2xl md:rounded-3xl overflow-hidden border border-border shadow-2xl min-h-0 lg:min-h-[650px]">
            ...
            {items.map((item, index) => (
              <div key={index} className="flex items-start gap-3 md:gap-4 text-right justify-start">
                ...
                <div className="flex flex-col gap-0.5 md:gap-1">
                  <h4 className="font-bold text-base md:text-lg text-secondary leading-none">{item.dimensions}</h4>
