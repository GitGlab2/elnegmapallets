  ...
  return (
    <div className="container py-12" id="achievements">
      <div className="relative min-h-[500px] rounded-3xl overflow-hidden border border-border shadow-2xl bg-[#181b24] p-8 md:p-16 flex flex-col justify-center">
        ...
        <div className="relative z-10 w-full flex flex-col gap-12 text-right">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
              {stats.map((stat, index) => (
                <motion.div
                  ...
                  className="flex flex-col items-center md:items-start text-center md:text-right gap-4 bg-[#202430]/40 p-6 rounded-2xl border border-border/40 hover:border-secondary hover:bg-[#202430]/80 transition-all duration-300 relative group"
                >
                  {/* Timeline dot connection */}
                  <div className="absolute top-0 md:top-1/2 left-1/2 md:left-auto md:right-0 w-4 h-4 bg-secondary border-4 border-[#181b24] rounded-full -translate-x-1/2 -translate-y-2 md:translate-x-2 md:-translate-y-1/2 shadow-[0_0_10px_rgba(177,101,251,0.5)] z-20 group-hover:scale-125 transition-transform" />
