...
export default function Gallery() {
  const slide8Items = [
    { src: "/images/client-gallery-4.jpg", title: "توريدات قطاع التصدير", desc: "شحنات بالتات خشبية معالجة حرارياً جاهزة للتصدير والموانئ." },
    { src: "/images/client-gallery-3.jpg", title: "أسطول الشحن والتوزيع", desc: "تحميل وتوريد البالتات لمختلف المحافظات والشركات." }
  ];

  const slide8bItems = [
    { src: "/images/client-gallery-2.jpg", title: "مستودعات التخزين الجاف", desc: "تخزين وتجفيف الأخشاب لضمان مطابقتها لأعلى معايير الجودة." },
    { src: "/images/client-gallery-1.jpg", title: "شحن وتنزيل البالتات للعملاء", desc: "تفريغ وتوريد آمن للبالتات في مواقع العمل والمصانع مباشرة." }
  ];
