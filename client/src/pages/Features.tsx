...
export default function Features() {
  ...
  return (
    <div className="container py-12" id="features">
          ...
          >
            ...
            <ul className="flex flex-col gap-5 mt-4">
              {advantages.map((adv, index) => (
                <li key={index} className="flex items-center gap-4 text-right justify-start">
                  <div className="shrink-0 p-1.5 rounded-full bg-secondary/15">
                    {adv.icon}
                  </div>
                  <span className="text-base md:text-lg text-white/95 font-medium leading-relaxed">
                    {adv.title}
                  </span>
                </li>
              ))}
