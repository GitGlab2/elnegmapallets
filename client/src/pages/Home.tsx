...
const OperationsVideo = lazy(() => import("./OperationsVideo"));
const TeamImageSlide = lazy(() => import("./TeamImageSlide"));
const Clients = lazy(() => import("./Clients"));
const Gallery = lazy(() => import("./Gallery"));
const Pricing = lazy(() => import("./Pricing"));
const Commitments = lazy(() => import("./Commitments"));
const Achievements = lazy(() => import("./Achievements"));
const FutureVision = lazy(() => import("./FutureVision"));
const Contact = lazy(() => import("./Contact"));

// Certifications uses named exports, wrap them
const CertificationsListLazy = lazy(() => import("./Certifications").then(m => ({ default: m.CertificationsList })));
const QualityCertImageLazy = lazy(() => import("./Certifications").then(m => ({ default: m.QualityCertImage })));
const InternationalStandardsImageLazy = lazy(() => import("./Certifications").then(m => ({ default: m.InternationalStandardsImage })));
