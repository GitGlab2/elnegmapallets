...
export const containerStuffingPhysicsArticle: Article = {
  ...
  keywords: ["سعة حاوية 20 قدم بالبالتات", "حاوية 40 قدم كم بالتة يورو", "حساب السعة الاستيعابية للحاوية", "الوزن الأقصى للحاوية", "المساحة الميتة في الحاويات", "رص البالتات في الحاوية"],
  toc: [
