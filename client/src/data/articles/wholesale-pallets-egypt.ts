    ...
    <div class="space-y-6 text-right leading-relaxed text-gray-200">
      ...
      <section>
        ...
        <ul class="list-disc list-inside text-xs text-gray-300 space-y-2 mt-2 pr-2">
          ...
          <li><strong>تعاقد مبكراً قبل الموسم:</strong> الطلب قبل موسم الذروة بشهر أو شهرين يضمن لك سعراً أفضل وتوريداً في الوقت المحدد.</li>
          <li><strong>وحّد المقاسات:</strong> طلب مقاس واحد أو اثنين بكميات كبيرة أوفر من طلب مقاسات متعددة بكميات صغيرة.</li>
          <li><strong>تعامل مع المصنع مباشرة:</strong> تجنب الوسطاء واشترِ مباشرة من مصنع بالتات معتمد لتوفير 15-25% من التكلفة.</li>
        </ul>
      </section>
