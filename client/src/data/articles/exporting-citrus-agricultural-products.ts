    ...
    <div class="space-y-6 text-right leading-relaxed text-gray-200">
      <section class="border-r-4 border-secondary pr-4 bg-muted/20 p-4 rounded-l-lg">
        ...
        <p class="text-sm text-gray-300">
          ...
          تخضع هذه الصادرات لإشراف صارم من الحجر الزراعي المصري للتأكد من امتثالها للمتطلبات الصحية العالمية ومعيار <strong>ISPM 15</strong> لمعالجة وتبخير البالتات الخشبية.
        </p>
      </section>
