...
4. **منعاً باتاً وضع مقاسات البالتات في الهيدر العلوي:** مقاسات وأبعاد البالتات يجب أن تُعامل وتُعرض كـ **مقالات عادية تماماً** بداخل قسم المقالات، ولا يجوز إضافتها إلى شريط التنقل العلوي (Header Navbar) تحت أي ظرف.
...
### أولوية متوسطة 💡
- **تفعيل روابط الفوتر:** في [Layout.tsx](file:///c:/Users/Islam%20Glab/Desktop/elnegmapallets/client/src/components/Layout.tsx)، روابط المنتجات في الفوتر تظهر كنصوص ثابتة (`<span>`)؛ يُنصح بتحويلها إلى روابط (`<a>`) تقود مباشرة إلى صفحات مقالات مقاسات البالتات المخصصة لها لتسهيل الزحف الداخلي والتنقل.
- **إكمال الـ Breadcrumbs Schema:** إضافة بيانات BreadcrumbList المنظمة لصفحات المقالات وتفاصيل مقالات المقاسات لتعزيز شكل الروابط في نتائج بحث جوجل.
