...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const service = servicesAr.find(s => s.slug === slug);
  if (!service) {
    return {
      title: "الخدمة غير موجودة | شركة النجمة",
    };
  }
  ...
  return {
    title: `${service.title} | شركة النجمة للبالتات الخشبية`,
...
export default async function Page({ params }: Props) {
  ...
  return (
    <>
      ...
      <ServiceDetails slug={slug} lang="ar" />
    </>
  );
}
