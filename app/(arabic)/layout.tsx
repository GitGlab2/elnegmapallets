        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "مصنع النجمة للبالتات الخشبية — الشركة رقم 1 في مصر لتصنيع البالتات الخشبية الجديدة والمعالجة حرارياً بختم ISPM-15. خبرة 18 عاماً في خدمة المصانع والمصدرين في مصر والشرق الأوسط.",
              "foundingDate": "2006",
                ...
                "itemListElement": [
                  {
                    ...
                    "itemOffered": {
                      ...
                      "description": "البالتة اليورو القياسية 120×80 سم — حمولة 1500 كجم — معالجة حرارية HT للتصدير لأوروبا",
                      "sku": "EUR1-120x80"
                    }
                  },
                  {
                    ...
                    "itemOffered": {
                      ...
                      "description": "البالتة الصناعية القياسية 120×100 سم — حمولة 1500 كجم — مثالية للتصدير للخليج والشرق الأوسط",
                      "sku": "IND-120x100"
                    }
                  },
                  {
                    ...
                    "itemOffered": {
                      ...
                      "description": "بالتة GMA المعيارية 48×40 بوصة — حمولة 1500 كجم — للتصدير لأمريكا الشمالية",
                      "sku": "GMA-121x101"
                    }
                  }
                ]
              ...
              "sameAs": [
                "https://github.com/GitGlab2/elnegmapallets"
              ]
            })
          }}
        />
